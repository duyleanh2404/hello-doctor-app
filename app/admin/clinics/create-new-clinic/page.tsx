...
import { createNewClinic } from "@/services/clinic-service";
...
const CreateNewClinic = () => {
  ...
  const handleCreateNewClinic: SubmitHandler<ClinicData> = async (clinicData) => {
    ...
    const { errorCode } = await createNewClinic({
      avatarName,
      bannerName,
      accessToken,
      avatar: avatarFile,
    ...
    if (errorCode === "CLINIC_ALREADY_EXISTS") {
      ...
      setError("name", {
        type: "manual",
        message: "Bệnh viện này đã được tạo!"
      });
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(handleCreateNewClinic)}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <Input
                  ...
                  accept="image/*"
                  {...register("banner", {
                    required: "Vui lòng tải tải ảnh bìa của chuyên khoa!"
                  })}
