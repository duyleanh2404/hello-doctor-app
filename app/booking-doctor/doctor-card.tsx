...
const DoctorCard = ({ doctor }: { doctor: DoctorData }) => {
  return (
    <Link
      ...
      className="group flex flex-col items-center gap-6 lg:border py-6 px-4 shadow-sm rounded-xl hover:shadow-xl transition duration-500 cursor-pointer"
    >
      <div className="w-full flex flex-col items-center gap-6">
        ...
        <Button
          type="button"
          variant="default"
          className="w-full h-12 text-[17px] font-semibold text-black py-3 bg-white border border-[#ccc] rounded-lg group-hover:text-white group-hover:bg-primary group-hover:border-transparent transition duration-500"
        >
          Đặt lịch khám
        </Button>
      </div>
