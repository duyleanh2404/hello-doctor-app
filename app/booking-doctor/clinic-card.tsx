...
const ClinicCard = ({ clinic }: { clinic: ClinicData }) => {
  return (
    <Link
      ...
      className="group lg:border shadow-sm hover:shadow-xl rounded-xl transition duration-500 cursor-pointer"
    >
      ...
      <div className="w-full p-4">
        <Button
          type="button"
          variant="default"
          className="w-full h-12 text-[17px] font-semibold text-black py-3 bg-white border border-[#ccc] rounded-lg transition duration-500 group-hover:text-white group-hover:bg-primary group-hover:border-transparent"
        >
          Đặt lịch khám
        </Button>
      </div>
