    ...
    >
      <div className="w-full flex flex-col items-center gap-6">
        <div className="relative w-[170px] h-[170px]">
          <Image loading="lazy" src={clinic?.avatar} alt="Avatar" fill className="w-full h-full object-contain" />
        </div>

        <div className="h-[100px] flex flex-col items-center gap-3">
          <h1 className="h-[65px] text-[17px] font-semibold text-center">{clinic?.name}</h1>
        ...
        <div className="w-full h-[75px] flex items-center gap-3 p-3 rounded-lg group-hover:bg-[#e3f2ff] transition duration-500">
          ...
          <Hint label={clinic?.address}>
            <p className="text-sm font-medium text-[#595959] line-clamp-2">{clinic?.address}</p>
          </Hint>
        </div>
