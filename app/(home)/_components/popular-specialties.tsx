    ...
    <LazyLoadComponent>
      <div className="wrapper py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8 sm:gap-0">
          ...
          >
            Xem tất cả
            <FaAngleRight size="13" className="group-hover:translate-x-2 transition duration-500" />
          </Link>
        </div>
            ...
            <CarouselContent>
              {specialties?.map((specialty: SpecialtyData) => (
                ...
                >
                  ...
                  >
                    <Image loading="lazy" src={specialty?.image} alt="Specialty" width={110} height={110} />
